...
<template>
 ...
 class="kv-key"
 style="flex: 1"
 @input=";(node as ResponseAssertion).patterns[i] = ($event.target as HTMLInputElement).value; update('patterns', [...(node as ResponseAssertion).patterns])"
 />
 <button
 class="kv-remove"
 @click="() => {const arr = [...(node as ResponseAssertion).patterns]; arr.splice(i, 1); update('patterns', arr)}"
 >
 x
 </button>
 </div>
 <button
 class="kv-add"
 @click="() => {const arr = [...(node as ResponseAssertion).patterns]; arr.push(''); update('patterns', arr)}"
 >
 + Add Pattern
 </button>
 </div>
 ...
 class="kv-key"
 list="http-headers"
 @input="h.key = ($event.target as HTMLInputElement).value; update('headers', [...(node as HttpDefaults).headers])"
 />
 <input
 type="text"
 :value="h.value"
 placeholder="Value"
 class="kv-value"
 @input="h.value = ($event.target as HTMLInputElement).value; update('headers', [...(node as HttpDefaults).headers])"
 />
 <button
 class="kv-remove"
 @click="() => {const hdrs = [...(node as HttpDefaults).headers]; hdrs.splice(i, 1); update('headers', hdrs)}"
 >
 x
 </button>
 </div>
 <button
 class="kv-add"
 @click="() => {const hdrs = [...(node as HttpDefaults).headers]; hdrs.push({ key: '', value: '' }); update('headers', hdrs)}"
 >
 + Add Header
 </button>
 </div>
 ...
 placeholder="Name"
 class="kv-key"
 @input="v.key = ($event.target as HTMLInputElement).value; update('variables', [...(node as UserVariables).variables])"
 />
 <input
 type="text"
 :value="v.value"
 placeholder="Value"
 class="kv-value"
 @input="v.value = ($event.target as HTMLInputElement).value; update('variables', [...(node as UserVariables).variables])"
 />
 <button
 class="kv-remove"
 @click="() => {const vars = [...(node as UserVariables).variables]; vars.splice(i, 1); update('variables', vars)}"
 >
 x
 </button>
 </div>
 <button
 class="kv-add"
 @click="() => {const vars = [...(node as UserVariables).variables]; vars.push({ key: '', value: '' }); update('variables', vars)}"
 >
 + Add Variable
 </button>
 </div>
 ...
 placeholder="Name"
 class="kv-key"
 @input="v.key = ($event.target as HTMLInputElement).value; update('parameters', [...(node as UserParameters).parameters])"
 />
 <input
 type="text"
 :value="v.value"
 placeholder="Value"
 class="kv-value"
 @input="v.value = ($event.target as HTMLInputElement).value; update('parameters', [...(node as UserParameters).parameters])"
 />
 <button
 class="kv-remove"
 @click="() => {const params = [...(node as UserParameters).parameters]; params.splice(i, 1); update('parameters', params)}"
 >
 x
 </button>
 </div>
 <button
 class="kv-add"
 @click="() => {const params = [...(node as UserParameters).parameters]; params.push({ key: '', value: '' }); update('parameters', params)}"
 >
 + Add Parameter
 </button>
 </div>
